...
document.addEventListener('DOMContentLoaded', () => {
    loadDatabase('quiz_v8.db');  // You can specify 'quiz-v1.db' or any version
});
...
function createChapterAndTestSelection() {
    ...
    startTestButton.className = 'btn btn-primary mt-3 ml-3';
    ...
    container.appendChild(startChapterButton);
    container.appendChild(startTestButton);
}
