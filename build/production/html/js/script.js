...
// https://quizstore.blob.core.windows.net/database will be replaced by build.bat for local/production
const dbBaseUrl = 'https://quizstore.blob.core.windows.net/database';
// quiz_v128.db will be replaced by build.bat for each build
const dbFileName = 'quiz_v128.db';
...
async function fetchCourses() {
    ...
    if (results.length > 0) {
        ...
        // Call createCourseSelection only. Test score API call is commented out for security.
        createCourseSelection(courses);

        /*
        // The following code is commented out due to security issues with api.qualia-sc.com
