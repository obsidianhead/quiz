...
document.addEventListener('DOMContentLoaded', () => {
    loadDatabase('quiz_v61.db');  // You can specify 'quiz-v1.db' or any version
});
...
function showQuestion(question) {
    ...
    try {
        // Attempt to parse with marked
        const parsedMarkdown = marked.parse(question.question);
        
        // Basic validation: Ensure it returns a string before setting innerHTML
